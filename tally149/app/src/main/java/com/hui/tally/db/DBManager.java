...
*   Mainly operate on the contents of the table, add, delete, modify and check
* */
public class DBManager {
    ...
    * */
    public static void initDB(Context context){
        DBOpenHelper helper = new DBOpenHelper(context);  //得到帮助类对象 get the object of helper
        db = helper.getWritableDatabase();      //得到数据库对象 get the object of db
    }
    ...
    public static List<TypeBean>getTypeList(int kind){
        ...
        //读取typetb表当中的数据
        //Read the data in the typetb table
        String sql = "select * from typetb where kind = "+kind;
        Cursor cursor = db.rawQuery(sql, null);
//        循环读取游标内容，存储到对象当中
        //Read the content of the cursor in a loop and store it in the object
    ...
    * Get all the expenses or incomes on a certain day in the accounting sheet
    * */
     ...
     * Get all expenditures or income in a certain month in the accounting sheet
     * */
    ...
    /** Count the number of expenditures or incomes in a certain month  */
    ...
    /**
     * Get the total amount of expenditure or income in a certain year
     * */
    ...
    * */
    ...
    /**
     * Search a list of income or expenditure according to the notes
     * */
    ...
    /**
     * 查询记账的表当中有几个年份信息
     * Query the year information in the accounting table
     * */
    ...
    * */
     ...
     * Query the total amount of money for each type of income or expenditure in a specified year and month
     * */
    ...
    * 获取这个月当中某一天收入支出最大的金额，金额是多少
     * Get the largest amount of income and expenditure on a certain day of the month, what is the amount
     * */
     ...
     * According to the collection of the total amount of income or expenditure
     * on each day of the specified month*/
