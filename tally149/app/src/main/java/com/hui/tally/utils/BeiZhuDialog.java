...
public class BeiZhuDialog extends Dialog implements View.OnClickListener {
    ...
    // 设定回调接口的方法 Method of setting callback interface
...
//    获取输入数据的方法 get the method of input data
...
//        获取窗口对象的参数 Get the parameters of the window object
        WindowManager.LayoutParams wlp = window.getAttributes();
//        获取屏幕宽度 Get screen width
        Display d = window.getWindowManager().getDefaultDisplay();
        wlp.width = (int)(d.getWidth());  //对话框窗口为屏幕窗口 The dialog window is a screen window
    ...
    Handler handler = new Handler(){
        ...
        public void handleMessage(@NonNull Message msg) {
            //自动弹出软键盘的方法 The method of automatically popping up the soft keyboard
